...
namespace Deed.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250908163036_Initial")]
            ...
            modelBuilder.Entity("Deed.Domain.Entities.Exchange", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Buy = 44.63f,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 8, 16, 30, 35, 833, DateTimeKind.Unspecified).AddTicks(2601), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
