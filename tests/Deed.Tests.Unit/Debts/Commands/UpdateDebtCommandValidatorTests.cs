...
public sealed class UpdateDebtCommandValidatorTests
{
    private readonly UpdateDebtCommandValidator _validator = new();

    private static UpdateDebtCommand ValidCommand => new(
        1, "Laptop", 1500m, CurrencyType.USD,
